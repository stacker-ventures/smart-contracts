...
BONUS: this allows us to distribute another token "alongside" the STACK distribution from the Gauge.
*/
...
contract GaugeD2_bonus is IERC20, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address payable public governance = 0x0Bc3BD0FFcC8197FD0F43998307F09C02fd09f1c; // STACK DAO address
    address public constant acceptToken = 0x8De755d4B198a1b1b79CE22239Bc83FfF7c73553; // stackToken rebase token
